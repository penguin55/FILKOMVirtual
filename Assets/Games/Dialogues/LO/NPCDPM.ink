...
=== Extra ===
    - {npc_nick}_{npc_role_m}: DPM (Dewan Perwakilan Mahasiswa) merupakan badan perwakilan legislatif mahasiswa yang memiliki tugas untuk mengemban kedaulatan dan memberikan kebijakan yang mencerminkan mahasiswa FILKOM. 
    - {npc_nick}_{npc_role_m}: Dengan kata lain DPM merupakan wakil mahasiswa yang mendengar seluruh keluhan mahasiswa serta aktif dalam meluangkan pemikiran untuk menyusun suatu kebijakan yang akan diberlakukan dalam lingkungan mahasiswa. 
    - {npc_nick}_{npc_role_m}: DPM dipilih melalui pemilihan umum “PEMILWA FILKOM” dengan mekanisme yang telah ditetapkan. DPM FILKOM terdiri dari 9 orang anggota yang berasal dari 5 program studi yaitu Teknik Informatika, Sistem Informasi, Teknik Komputer, Pendidikan Teknologi Informasi dan Teknologi Informasi.
