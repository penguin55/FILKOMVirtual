...
=== Extra ===
    - {npc_nick}_{npc_role_m}: Raion Community adalah salah satu Lembaga Semi Otonom (LSO) yang berada di lingkungan Fakultas Ilmu Komputer yang bergerak dibidang pengembangan games dan aplikasi mobile.
    - {npc_nick}_{npc_role_m}: Di dalam Raion terdapat 3 divisi yaitu Programmer, Artist dan Designer.
    - {npc_nick}_{npc_role_m}: Divisi Programmer adalah divisi yang bertugas untuk merealisasikan desain atau ide, baik aplikasi maupun game yang telah dibuat oleh Designer, juga aset dari Artist sehingga bisa terealisasi dalam game maupun aplikasi tersebut.
    - {npc_nick}_{npc_role_m}: Divisi artist adalah divisi yang bertanggung jawab dalam pembuatan aset visual atau audio dalam pembuatan aplikasi atau game.
    - {npc_nick}_{npc_role_m}: Yang terakhir adalah Designer yang bertugas untuk merancang keseluruhan konsep yang akan diterapkan dalam aplikasi atau game yang akan dibuat.
