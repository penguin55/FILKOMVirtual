...
=== Extra ===
    - {npc_nick}_{npc_role_m}: BIOS (Badan Internal Olahraga dan Seni) merupakan Lembaga Semi Otonom (LSO) di Fakultas Ilmu Komputer (FILKOM) Universitas Brawijaya yang berfokus pada kegiatan olahraga dan seni.
