...
=== Extra ===
    - {npc_nick}_{npc_role_m}: LPM adalah Lembaga Pers Mahasiswa yaitu sebuah lembaga semi otonom yang bergerak dalam dunia jurnalistik. LPM di Fakultas Ilmu Komputer (FILKOM) menamakan dirinya LPM DISPLAY.
    - {npc_nick}_{npc_role_m}: Sesuai dengan pengertian umum bahwa display merupakan suatu alat yang menyajikan informasi tentang lingkungan yang dikomunikasikan, maka LPM DISPLAY menyajikan berbagai informasi teraktual dan akurat baik dalam bidang sosial, budaya maupun teknologi untuk masyarakat umum khususnya keluarga besar FILKOM dan Universitas Brawijaya.
