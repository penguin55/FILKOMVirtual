...
=== Extra ===
    - {npc_nick}_{npc_role_m}: Optiik merupakan salah satu LSO yang berfokus pada pengembangan kreatifitas dan inovasi yang berfokus pada bidang fotografi dan desain bagi mahasiswa FILKOM. 
    - {npc_nick}_{npc_role_m}: Dengan tujuan meningkatkan dan mengembangkan kreatifitas, ketrampilan dan kemampuan di bidang seni fotografi dan desain, diharapkan anggota komunitas dapat membentuk kewirausahaan mandiri di bidang seni fotografi dan desain.
